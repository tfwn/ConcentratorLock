...
const uint8 Default_DscIp[] = {101,37,117,100};
const uint16 Default_DscPort = 4000;
const uint8 Default_BackupDscIp[] = {101,37,117,100};
const uint16 Default_BackupDscPort = 4000;
