...
************************************************************************************************/
uint8 BroadcastAddrIn[LONG_ADDR_SIZE] = {0xD5, 0xD5, 0xD5, 0xD5, 0xD5, 0xD5, 0xD5, 0xD5};
uint8 BroadcastAddrOut[LONG_ADDR_SIZE] = {0xD4, 0xD4, 0xD4, 0xD4, 0xD4, 0xD4, 0xD4, 0xD4};
uint8 NullAddress[LONG_ADDR_SIZE] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
